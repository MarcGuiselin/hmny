...
pub use cosmic_text::{
    Action, Attrs, AttrsList, AttrsOwned, Buffer, BufferLine, Cursor, Edit, Editor, Family,
    FontSystem, Metrics, Shaping, SwashCache,
};
...
const FONTS_LOAD_DIR: &str = "./assets/fonts";
...
pub struct ActiveEditor(Option<Entity>);
